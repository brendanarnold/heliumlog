...
class HeTransferForm(Form):
    ...
    meter_before = IntegerField('Before', [Required()])
    meter_after = IntegerField('After', [Required()])
    transport_dewar = SelectField('Transport Dewar', choices=create_choices(transport_dewars))
    transport_dewar_before = IntegerField('Before', [Required()])
    transport_dewar_after = IntegerField('After', [Required()])
    cryostat = SelectField('Cryostat', choices=create_choices(cryostats))
    cryostat_before = IntegerField('Before', [Required()])
    cryostat_after = IntegerField('After', [Required()])
